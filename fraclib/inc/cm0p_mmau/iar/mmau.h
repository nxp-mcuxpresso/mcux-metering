...
{                                                                              \
  ...
  __asm volatile ("stm %0!,{%Q1,%R1}":"=l"(addr):"Rp"(inp),"0"(addr));         \
}
...
static inline uint64 d_urda (void)
{
  ...
  __asm volatile ("ldm %Q0,{%Q0,%R0}":"=Rp"(out.d):"0"(out.d));
  return (uint64)out.d;
}
...
static inline uint64 d_umul_ll (register uint32 lval1, register uint32 lval2)
{
  ...
  (
    "stm %0!,{%Q1,%R1}\n"
    "ldm %0!,{%Q1,%R1}  ":"=l"(addr),"=Rp"(out.d):"0"(addr),"1"(out.d)
  );
  return (uint64)out.d;
}
...
static inline uint64 d_umul_dl (register uint64 dval, register uint32 lval)
{
  ...
  (
    "stm %0!,{%Q1,%R1}\n"
    "stm %0!,{%2}     \n"
    "ldm %0!,{%Q1,%R1}  ":"=l"(addr),"=Rp"(dval):"l"( lval),"0"(addr),"1"(dval)
  );
  return (uint64)dval;
}
...
{                                                                              \
  ...
  (                                                                            \
    "stm %0!,{%Q1,%R1}\n"                                                      \
    "str %2 ,[%0,#+0]   ":"=l"(addr):"Rp"(inp1),"l"(inp2),"0"(addr)            \
  );                                                                           \
}
...
static inline uint32 l_udiv_ll (register uint32 lnum, register uint32 lden)
{
  ...
  (
    "str %1,[%0,#+0]\n"
    "str %2,[%0,#+4]\n"
    "ldr %0,[%0,#+8]  ":"=l"(out):"l"(lnum),"l"(lden),"0"(out)
  );
  return (uint32)out;
}
...
static inline uint64 d_udiv_dl (register uint64 dnum, register uint32 lden)
{
  ...
  (
    "stm %0!,{%Q1,%R1}\n"
    "stm %0!,{%2}     \n"
    "ldm %0!,{%Q1,%R1}  ":"=l"(addr),"=Rp"(dnum):"l"( lden),"0"(addr),"1"(dnum)
  );
  return (uint64)dnum;
}
...
static inline uint64 d_udiv_dd (register uint64 dnum, register uint64 dden)
{
  ...
  (
    "stm %0!,{%Q1,%R1}\n"
    "stm %0!,{%Q2,%R2}\n"
    "ldm %0!,{%Q1,%R1}  ":"=l"(addr),"=Rp"(dnum):"Rp"(dden),"0"(addr),"1"(dnum)
  );
  return (uint64)dnum;
}
...
{                                                                              \
  ...
  (                                                                            \
    "stm %0!,{%Q1,%R1}\n"                                                      \
    "stm %0!,{%Q2,%R2}  ":"=l"(addr):"Rp"(inp1),"Rp"(inp2),"0"(addr)           \
  );                                                                           \
}
...
static inline uint64 d_udiva_d (register uint64 dden)
{
  ...
  (
    "stm %0!,{%Q1,%R1}\n"
    "ldm %0!,{%Q1,%R1}  ":"=l"(addr),"=Rp"(dden):"0"(addr),"1"(dden)
  );
  return (uint64)dden;
}
...
static inline uint16 s_usqr_l (register uint32 lrad)
{
  ...
  (
    "str %0,[%1,#+0]\n"
    "ldr %0,[%1,#+4]  ":"=l"(lrad):"l"(addr),"0"(lrad)
  );
  return (uint16)lrad;
}
...
static inline frac32 l_mul_ll (register frac32 lval1, register frac32 lval2)
{
  ...
  (
    "str %1,[%0, #+0]\n"
    "str %2,[%0, #+4]\n"
    "ldr %0,[%0,#+12]  ":"=l"(out):"l"(lval1),"l"( lval2),"0"(out)
  );
  return (frac32)out;
}
...
static inline frac32 l_mul_dl (register frac64 dval, register frac32 lval)
{
  ...
  (
    "stm %0!,{%Q1,%R1}\n"
    "stm %0!,{%2}     \n"
    "ldr %0 ,[%0,#+4]   ":"=l"(out):"Rp"(dval),"l"( lval),"0"(out)
  );
  return (frac32)out;
}
...
static inline frac32 l_mula_l (register frac32 lval)
{
  ...
  (
    "str %0,[%1,#+0]\n"
    "ldr %0,[%1,#+8]  ":"=l"(lval):"l"(addr),"0"(lval)
  );
  return (frac32)lval;
}
...
static inline frac32 l_div_ll (register frac32 lnum, register frac32 lden)
{
  ...
  (
    "str %1,[%0, #+0]\n"
    "str %2,[%0, #+4]\n"
    "ldr %0,[%0,#+12]  ":"=l"(out):"l"(lnum),"l"(lden),"0"(out)
  );
  return (frac32)out;
}
...
static inline frac32 l_diva_l (register frac32 lden)
{
  ...
  (
    "str %0,[%1,#+0]\n"
    "ldr %0,[%1,#+8]  ":"=l"(lden):"l"(addr),"0"(lden)
  );
  return (frac32)lden;
}
...
static inline frac16 s_sqr_l (register frac32 lrad)
{
  ...
  (
    "str %0,[%1,#+0]\n"
    "ldr %0,[%1,#+8]\n"
    "asrs %0,%0,#+16  ":"=l"(lrad):"l"(addr),"0"(lrad):"cc"
  );
  return (frac16)lrad;
}
